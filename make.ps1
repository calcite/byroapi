...
#>
function lint() {
    poetry run flake8 src\byroapi tests
}
...
#>
function test() {
    poetry run python test.test_byroapi.py
}
...
#>
function coverage() {
    poetry run coverage run --source src\byroapi -m test.test_byroapi.py
...
#>
function docs(){
    if (Test-Path ".\docs\byroapi.rst") { Remove-Item ".\docs\byroapi.rst" -Force }
    if (Test-Path ".\docs\modules.rst") { Remove-Item ".\docs\modules.rst" -Force }
    poetry run sphinx-apidoc -o docs\ src\byroapi
